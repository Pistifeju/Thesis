...
class CustomAuthTextField: UITextField {
    ...
    private func configureUI() {
        ...
        case .username:
            self.attributedPlaceholder = NSAttributedString(string: "Username", attributes: [.foregroundColor: UIColor.systemGray])
        case .email:
            self.attributedPlaceholder = NSAttributedString(string: "Email", attributes: [.foregroundColor: UIColor.systemGray])
            self.keyboardType = .emailAddress
            self.textContentType = .emailAddress
        case .password:
            self.attributedPlaceholder = NSAttributedString(string: "Password", attributes: [.foregroundColor: UIColor.systemGray])
